# Workspace Memory Router

Scope: the single Git repository at this workspace root. Current source, tests,
configuration, and runtime evidence override every memory note.

Open only the route that matches the user's exact surface:
...
| Repository or crate ownership is unclear | [`project/solaris/MEMORY.md`](project/solaris/MEMORY.md) |

Do not open every note at startup. Historical plans and unchecked boxes are not
current status until verified against Git and the runtime.
