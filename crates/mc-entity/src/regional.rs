...
#[derive(Clone)]
struct RegionalOwnerLaneReader {
    sender: SyncSender<RegionOwnerLaneMessage>,
    admission: Arc<Mutex<()>>,
}
...
impl RegionalOwnerLaneReader {
    ...
    fn request_existing_snapshots_for_ids(
        &self,
        entities: Vec<(RegionLease, EntityId)>,
    ...
    fn request_alive_kinematics_for_ids(
        &self,
        entities: Vec<(RegionLease, EntityId)>,
    ...
    fn rollback_committed(&self, phase: RegionPhase) -> Result<(), RegionOwnerLaneError> {
...
impl RegionalOwnerLane {
    ...
    fn request_snapshots(&self) -> Result<Receiver<Vec<EntitySnapshot>>, RegionOwnerLaneError> {
        #[cfg(test)]
    ...
    fn request_breeding_tick_snapshots(
        &self,
            ...
            lane.prepare(super::RegionOwnerBatch {
                ...
                mutations: vec![
                    super::SequencedRegionMutation {
                        sequence: 1,
                        lease: west,
                        mutation: super::RegionOwnerMutation::InsertSnapshot(Box::new(
                            west_snapshot,
                        )),
                    },
                    super::SequencedRegionMutation {
