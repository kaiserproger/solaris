...
use mc_protocol::packets::play::{
    AddEntity, ClientboundKeepAlive, ClientboundSetTime, EntityPositionSync, LevelChunkWithLight,
    MoveEntityPos, MoveEntityPosRot, ServerboundChatCommand, ServerboundKeepAlive,
};
...
async fn embedded_villager_schedule_switches_rest_to_work_over_tcp() {
    ...
    let (mut client, spawn) = Client::connect_to_play(addr, "VillScheduleTcp")
        .await
