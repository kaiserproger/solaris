...
async fn survival_double_chest_opens_combined_storage_and_mutates_second_half_inner() {
    ...
    left_chest.slots[0] = mc_world::FurnaceSlot { item_id: dirt_id, count: 5, damage: None, enchantments: Vec::new(), custom_name: None, item_model: None, stew_effects: Vec::new() };
    let mut right_chest = mc_world::ChestBlockEntity::default();
    right_chest.slots[0] = mc_world::FurnaceSlot { item_id: dirt_id, count: 7, damage: None, enchantments: Vec::new(), custom_name: None, item_model: None, stew_effects: Vec::new() };
