...
use mc_protocol::packets::play::{
    AddEntity, ClientboundKeepAlive, ClientboundSetHealth, EntityPositionSync, LevelChunkWithLight,
    MoveEntityPos, MoveEntityPosRot, RemoveEntities, ServerboundChatCommand, ServerboundKeepAlive,
};
...
async fn embedded_dragon_air_combat_moves_fires_clouds_damages_and_discards_over_tcp() {
    ...
    let (mut client, spawn) = Client::connect_to_play(addr, "DragonTcp")
        .await
