...
use mc_protocol::packets::play::{
    ...
    ClientboundContainerSetSlot, ClientboundCooldown, ClientboundDamageEvent, ClientboundExplode,
    ClientboundKeepAlive, ClientboundOpenScreen, ClientboundOpenSignEditor, ClientboundRespawn,
    ClientboundSetEntityData, ClientboundSetExperience, ClientboundSetHealth, ClientboundSetTime,
    ClientboundSystemChat, ClientboundTakeItemEntity, ConfirmTeleportation, ContainerInput,
    Direction, EntityAnimation, EntityAnimationAction, EntityDataValue, EntityEvent, EntityPose,
    EntityPositionSync, EntityVec3, GameEvent, GameMode, HashedStack, HashedStackComponentHashes,
    ITEM_ENTITY_DATA_ITEM_INDEX, InteractionHand, ItemStack, LIVING_ENTITY_DATA_FLAGS_INDEX,
    LIVING_ENTITY_FLAG_USING_ITEM, LevelChunkWithLight, LevelEvent, LightUpdate, MoveEntityPos,
    MoveEntityPosRot, MovePlayerFlags, PlayerActionKind, PlayerCommandAction, PlayerInput,
    RemoveEntities, SHEEP_ENTITY_DATA_WOOL_INDEX, SectionBlocksUpdate, ServerboundChatCommand,
