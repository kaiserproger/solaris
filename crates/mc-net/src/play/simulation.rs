...
#[cfg(test)]
#[derive(Debug, Clone)]
pub(super) struct RegionalBlockEditProbe {
...
impl RegionalBlockEditProbe {
    pub(super) fn enter(&self, region: RegionKey) {
...
impl SimulationOwner {
    ...
    #[cfg(test)]
    pub(super) fn install_regional_block_edit_probe(
        &mut self,
        entered: std::sync::mpsc::Sender<RegionKey>,
    ...
    async fn process_regional_block_edit_run(
        &mut self,
        sessions: &SessionRegistry,
        access: SimulationWorldAccess<'_>,
        block_light: Option<&BlockLightTable>,
        journal: Option<&super::world_journal::WorldChunkJournal>,
