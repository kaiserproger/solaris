...
RUNNER="$ROOT/tools/harness/backends/oracle.sh"
FIXTURES="${M79_ORACLE_CHECK_ROOT:-$ROOT/.analysis/oracle-suite/runner-checks}"
...
mkdir -p "$FIXTURES"
FIXTURES="$(mktemp -d "$FIXTURES/run-XXXXXX")"
