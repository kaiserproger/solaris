...
echo "[2/6] Reading version metadata…"
...
echo "[3/6] Extracting data subset to $OUT_DIR …"
...
echo "[4/6] Generating data reports via server's own data generator …"
mkdir -p "$TMP/datagen"
if ! (
  cd "$TMP/datagen"
...
echo "[5/6] Extracting block-light report …"
