...
Next: close the common damage-source matrix. Melee, projectile, fall,
fire/lava, drowning, suffocation and starvation must share authoritative
reductions and immunity boundaries, while non-finite and unsupported sources
fail closed. This checkpoint has unit and wire legs and no client-rig dependency.
