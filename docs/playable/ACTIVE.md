...
Next: prove player death inventory and XP conservation. One authoritative death
commit must publish exact item/XP consequences once, keepInventory and mode
boundaries must be explicit, and respawn/restart must not reclaim stale inventory
or duplicate drops. This checkpoint has unit, wire and persistence legs and no
