...
with no protocol-1/2 compatibility path. Server plugin frontends are retained
Luau API `0.6.0` and WASM component API `0.7.0`; selecting either does not
change the client wire protocol or artifact schema.
