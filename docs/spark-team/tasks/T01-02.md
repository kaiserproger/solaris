...
| Agent | `solaris_worker` |
| Worktree / branch | `/home/kaiserroman/solaris` / `main` |
...
- BASELINE/RED
  - `cd client-mod/solaris-client-agent && ./gradlew :java-agent:test --tests "*M94BlocksFluidsFarmingDropsScenarioTest*"` -> `/home/kaiserroman/solaris/.analysis/runs/t01-02-a/val-red-java.log`
  - `cargo test -p mc-test-harness --test real_client_manifest` -> `/home/kaiserroman/solaris/.analysis/runs/t01-02-a/val-red-real-client.log`
  - `SOLARIS_REAL_CLIENT_AGENT_SCENARIO=m94-02-blocks-fluids-farming-drops bash tools/run-real-client-regression.sh --run` -> `/home/kaiserroman/solaris/.analysis/runs/t01-02-a/val-red-real-client-smoke.log`
...
diff_hash: 7c649bdeeaa67e4684942bba802f1650629cbc4034747ebc83f7317076a212c0
changed_files:
  - client-mod/solaris-client-agent/java-agent/src/main/java/dev/solaris/agent/javaagent/M94BlocksFluidsFarmingDropsScenario.java
  - client-mod/solaris-client-agent/java-agent/src/test/java/dev/solaris/agent/javaagent/M94BlocksFluidsFarmingDropsScenarioTest.java
  - docs/spark-team/tasks/T01-02.md
validation: [unit, manifest, real-client-smoke]
evidence: [unit, manifest, real-client-smoke]
known_gaps: [missing `no_debug_commands` flag for scenario m94-02-blocks-fluids-farming-drops in manifest/schema]
next: add `no_debug_commands` to m94-02-blocks-fluids-farming-drops scenario declaration and rerun smoke command to close real-client leg
```
