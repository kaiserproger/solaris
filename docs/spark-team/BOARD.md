...
- [x] [`T01-06` — Добавить vanilla oracle для inventory/crafting/container state machine](tasks/T01-06.md) — **P0**, rows `I1,I2,K1,Q1`, deps `T00-04,T01-01`, locks `ORACLE,RUST-HARNESS`
